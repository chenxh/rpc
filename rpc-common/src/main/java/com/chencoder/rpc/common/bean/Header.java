...
import com.chencoder.rpc.common.ProtoVersion;
import com.chencoder.rpc.common.config.MethodConfig;
...
public class Header {
    ...
    public static class HeaderMaker {
        ...
        public HeaderMaker loadWithMethodConfig(MethodConfig config) {
            header.setExtend(RpcUtil.getExtend(config.getSerializeType(), config.getCompressType()));
            return this;
        }
